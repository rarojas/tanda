...
export default function profileReducer (state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case GET_PROFILE_SUCCESS:
      ...
      .setIn(['form', 'originalProfile', 'objectId'], action.payload._id)
      .setIn(['form', 'error'], null)
  ...
  case GET_TANDA_SUCCESS:
      var map = Immutable.fromJS(action.payload.tandas);
      return state.setIn(['form', 'isFetching'], false)
      .setIn(['form', 'tandas' ], map)
      .setIn(['form', 'error'], null)
